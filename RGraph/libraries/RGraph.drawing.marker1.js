// version: 2020-02-01
    ...
    RGraph.Drawing.Marker1 = function (conf)
    {
        ...
        this.draw = function ()
        {
            ...
            this.path({
                path: 'c s % f %',
                args: [prop.colorsStroke,prop.colorsFill]
            });
        ...
        this.getShape = function (e)
        {
            ...
            if (this.context.isPointInPath(mouseXY[0], mouseXY[1])) {
                ...
                if (RGraph.parseTooltipText && prop.tooltips) {
                    var tooltip = RGraph.parseTooltipText(prop.tooltips[0], 0);
                }
        ...
        this.drawMarker = function ()
        {
            ...
            if (prop.align === 'left') {
                ...
                this.path({path: 'a % % % % % false', args: [x,y,r,RGraph.HALFPI,RGraph.TWOPI]});
                
                this.path({path: 'qc % % % %', args: [x + r,y + r,x + r + r,y + r + r]});
                this.path({path: 'qc % % % %', args: [x + r,y + r,x,y + r]});
                ...
                this.path({path: 'a % % % % % true',args: [x,y,r,RGraph.HALFPI,RGraph.PI]});
            ...
            // Default is center
                ...
                this.path({path: 'a % % % % % true', args: [x, y, r, RGraph.HALFPI / 2, RGraph.PI - (RGraph.HALFPI / 2)]});
                
                // special case for MSIE 7/8
                this.path({path: 'qc % % % %', args: [x,y + r + (r / 4),x,y + r + r - 2]});
                this.path({path: 'qc % % % %', args: [x,y + r + (r / 4),x + (Math.cos(RGraph.HALFPI / 2) * r),y + (Math.sin(RGraph.HALFPI / 2) * r)]});
            }

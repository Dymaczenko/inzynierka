// version: 2020-02-01
    ...
    RGraph.SemiCircularProgress = function (conf)
    {
        ...
        this.drawMeter = function ()
        {
            ...
            this.path({
                path: 'lw % b a % % % % % false a % % % % % true c s % f % sx % sy % sc % sb % f % sx 0 sy 0 sb 0 sc rgba(0,0,0,0) lw 1',
                args: [
                    prop.linewidth,
        ...
        this.highlight = function (shape)
        {
            if (typeof prop.highlightStyle === 'function') {
                ...
                this.path({
                    path: 'lw 5 b a % % % % % false a % % % % % true c f % s % lw 1',
                    args: [

                ...
                this.context.beginPath();
                    ...
                    if (this.type === 'pie' && prop.variant.indexOf('donut') !== -1) {
                        this.context.arc(
                            angles[i][2],
                            angles[i][3],
                            (typeof prop.variantDonutWidth == 'number' ? this.radius - prop.variantDonutWidth : this.radius / 2),
                            angles[i][1],
                            angles[i][0],
                            true
                        );
